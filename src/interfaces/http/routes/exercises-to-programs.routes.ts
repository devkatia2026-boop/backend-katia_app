...
import type { ExercisesToProgramsController } from '../controllers/exercises-to-programs.controller';

export function createExercisesToProgramsRoutes(
  controller: ExercisesToProgramsController,
