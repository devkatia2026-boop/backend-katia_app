...
import type { ExercisesToTrainingsController } from '../controllers/exercises-to-trainings.controller';

export function createExercisesToTrainingsRoutes(
  controller: ExercisesToTrainingsController,
