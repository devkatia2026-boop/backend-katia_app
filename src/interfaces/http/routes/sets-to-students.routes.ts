...
import type { SetsToStudentsController } from '../controllers/sets-to-students.controller';

export function createSetsToStudentsRoutes(
  controller: SetsToStudentsController,
